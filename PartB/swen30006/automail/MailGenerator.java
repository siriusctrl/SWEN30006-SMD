...
public class MailGenerator {
     ...
     */
    public MailGenerator(int mailToCreate, HashMap<Boolean,Integer> seed, boolean fragile){
    ...
    /**
     * Getter for all mails
     * @return allMail All mails to deliver.
     */
    public HashMap<Integer,ArrayList<MailItem>> getAllMail() {
    		return allMail;
    }
